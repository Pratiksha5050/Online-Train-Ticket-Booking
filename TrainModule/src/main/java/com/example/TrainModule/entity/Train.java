...
public class Train{
    ...
    private double sleeperCoachPrice;
	...
	public Train(String trainNo, String trainName, String sourceStation, String destinationStation,
			...
			int seatsInFirstClassClass, int seatsInSecondClassClass, int seatsInThirdClassClass, double firstClassPrice,
			double secondClassPrice, double thirdClassPrice, double sleeperCoachPrice) {
		super();
		...
		this.sleeperCoachPrice = sleeperCoachPrice;
	}
	...
	public double getSleeperCoachPrice() {
		return sleeperCoachPrice;
	}
	...
	public void setSleeperCoachPrice(double sleeperCoachPrice) {
		this.sleeperCoachPrice = sleeperCoachPrice;
	}
